...
@section('caption', 'Welcome to '.config('app.name') )
            ...
            <div class="panel-body">
                <div class="list-group">
                    ...
                    <a href="{{ URL::to('tasks/view/' . $result['id']) }}" class="list-group-item">
                        ...
                        <span class="badge badge" style="background-color: #ca4e6e !important;">Duration:
                            {{ $result['duration'] . ' days' }}</span>
            ...
            <div class="panel-body">
                <div class="list-group">
                    ...
                    <a href="{{ URL::to('companies/view/' . $result->id) }}" class="list-group-item">
                        ...
                        <span class="badge badge" style="background-color: #ff9800 !important;">Phone:
                            {{ $result->phone }}</span>
                    </a>
                    @endforeach
                    @else
